...
<head>
	...
	<title>Rental Mobil & Motor | Admin Edit Info Motor</title>
...
function valid(theform){
		...
		alert ('Hanya huruf yang diperbolehkan untuk Nama Motor!');
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=intval($_GET['id']);
										$sql ="SELECT motor.*,merek.* FROM motor, merek WHERE motor.id_merek=merek.id_merek AND motor.id_motor='$id'";
