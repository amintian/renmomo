...
$sql = "SELECT id_motor from motor";
...
<?php 
$sql1 = "SELECT motor.*,merek.* FROM motor,merek WHERE merek.id_merek=motor.id_merek";
 ...
 ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href="motor-details.php?vhid=<?php echo htmlentities($result['id_motor']);?>"><?php echo htmlentities($result['nama_merek']);?> , <?php echo htmlentities($result['nama_motor']);?></a></h5>
            ...
            <a href="motor-details.php?vhid=<?php echo htmlentities($result['id_motor']);?>" class="btn">Lihat Detail <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
     ...
     <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
			<?php
				$sql2 = "SELECT motor.*,merek.* FROM motor,merek 
						WHERE merek.id_merek=motor.id_merek order by merek.id_merek desc limit 4";
				...
				if(mysqli_num_rows($query2)>0)
				{
					...
					{ ?>
					<li class="gray-bg">
						<div class="recent_post_img"> <a href="motor-details.php?vhid=<?php echo htmlentities($result['id_motor']);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result['image1']);?>" alt="image"></a> </div>
						<div class="recent_post_title"> <a href="motor-details.php?vhid=<?php echo htmlentities($result['id_motor']);?>"><?php echo htmlentities($result['nama_merek']);?> , <?php echo htmlentities($result['nama_motor']);?></a>
